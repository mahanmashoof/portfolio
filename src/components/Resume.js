...
function Resume() {
  return (<div id="resume" className="row">
    <div className="col">
      <a href="./../CV_Mahan_Mashoof_Eng.doc" type="button" className="btn btn-dark btn-block" download><FontAwesomeIcon className="icon" icon={faDownload} size="1x"/>Resume (Eng)</a>
    </div>
    <div className="col">
